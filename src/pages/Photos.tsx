          ...
          <div className="p-4">
            ...
            <Tabs defaultValue="throwbacks" onValueChange={handleTabChange} className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                <TabsTrigger value="throwbacks">Throwbacks of Jonny</TabsTrigger>
                <TabsTrigger value="inspiration">Party Inspo</TabsTrigger>
                <TabsTrigger value="party">Party Night</TabsTrigger>
              </TabsList>
